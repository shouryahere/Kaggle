...
def list_task_lists() -> dict:
    ...
    try:
        ...
        return {
            ...
            "message": f"📋 Found {len(task_lists)} task lists"
        }
...
def complete_task(task_id: str, task_list_id: str = "@default") -> dict:
    ...
    try:
        ...
        return {
            ...
            "message": f"✅ Task '{updated.get('title')}' marked as complete!"
        }
...
def search_google_photos(query: str, max_results: int = 10) -> dict:
    ...
    try:
        ...
        return {
            ...
            "query": query,
            "photos": photos,
            "message": f"📸 Found {len(photos)} photos" if photos else "No photos found"
        }
        ...
        if "insufficient authentication scopes" in error_str.lower() or "403" in error_str:
            return {
                ...
                "message": "📸 Google Photos access is not available. The Photos Library API requires Google verification for sensitive scopes.",
                "alternatives": [
...
def list_photo_albums() -> dict:
    ...
    try:
        ...
        return {
            ...
            "albums": album_list,
            "message": f"📁 Found {len(album_list)} albums"
        }
        ...
        if "insufficient authentication scopes" in error_str.lower() or "403" in error_str:
            return {
                "success": False,
                "message": "📸 Google Photos access requires additional setup. Visit https://photos.google.com directly.",
...
def get_photos_from_album(album_id: str, max_results: int = 25) -> dict:
    ...
    try:
        ...
        return {
            ...
            "album_id": album_id,
            "photos": photos,
            "message": f"📸 Found {len(photos)} photos in album"
        }
